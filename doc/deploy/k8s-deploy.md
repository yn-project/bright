...
![deploy steps](https://raw.githubusercontent.com/bright-io/bright/master/doc/picture/deploy-steps.png)
...
| 集群角色 | TARGET_ENV                                      |
|------|-------------------------------------------------|
| 开发环境 | bright-development-idc、bright-development-aws |
| 测试环境 | bright-testing-idc、bright-testing-aws         |
| 生产环境 | bright-production-idc、bright-production-aws   |

以下的TARGET_ENV使用bright-testing-*为例子
